...
public class View {
    ...
    public void displayMenu() {
        ...
        System.out.println("E.G. medicine (X=1) - get all (Y=1): 11");
        System.out.println("     medicine storage (X=3) - update (Y=4): 34");
        System.out.println("     producer (X=4) - get one (Y=2): 42");
        System.out.println("------------------------------------------------------------------------");
    }
    ...
    private MedicineCategories getMedicineCategoriesInputs() {
        System.out.println("\nEnter  ID: ");
        Integer id = SCANNER.nextInt();
        System.out.println("Enter medicine categories: ");
        String categories = SCANNER.next();


        return new MedicineCategories(id, categories);
    }
    ...
    private Medicine getMedicineInputs() {
        ...
        Integer medicine_storage_id = SCANNER.nextInt();
        System.out.println("Enter medicine_categories_id: ");
        Integer medicine_categories_id = SCANNER.nextInt();
        System.out.println("Enter using_in_life_id: ");
        Integer using_in_life_id = SCANNER.nextInt();

        return new Medicine(id, name, price, medicine_storage_id, medicine_categories_id, using_in_life_id);
    }
    ...
    private MedicineStorage getMedicineStorageInputs() {
        System.out.println("\nEnter Medicine Storage : ");
        String storage = SCANNER.nextLine();

        return new MedicineStorage(storage);
    }
    ...
    private Producer getProducerInputs() {
        ...
        String name_producer = SCANNER.next();

        return new Producer( id, name_producer);
    }
    ...
    private UsingInLife getUseInLifeInputs() {
        System.out.println("\nEnter name: ");
        String using_in = SCANNER.next();

        return new UsingInLife(-1, using_in);
    }

    private void createUseInLife() throws SQLException {
        System.out.println("[Use In Life / CREATE]");
        UsingInLife usingInLife = getUseInLifeInputs();
