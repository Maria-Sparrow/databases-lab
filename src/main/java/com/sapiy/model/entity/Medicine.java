...
public class Medicine {
    ...
    public Medicine(Integer id, String name, String price, MedicineStorage medicineStorage, MedicineCategories medicineCategory, UsingInLife usingInLife) {
        this.id = id;
        this.name = name;
        this.price = price;
    ...
    public Medicine(String name, String price, MedicineStorage medicineStorage, MedicineCategories medicineCategory, UsingInLife usingInLife) {
        this.name = name;
        this.price = price;
        this.medicineStorage = medicineStorage;
        this.medicineCategory = medicineCategory;
    ...
    public MedicineCategories getMedicineCategory() {
        return medicineCategory;
    }

    public void setMedicineCategory(MedicineCategories medicineCategories) {
